...
def SetupStubs(app_id, **config):
  ...
  # logging.info('ripping the heart out')
  # if we make these urls correspond to our login service, we'll be able to have our own single-signon across appdrop apps
